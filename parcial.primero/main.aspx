<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="main.aspx.cs" Inherits="parcial.primero.WebForm1" %>
          ...
          <div class="card-body">
               ...
               <div class="form-row">
                   ...
                   <div class="form-group col-md-4">
                        ...
                        Display="Dynamic" SetFocusOnError="True" ForeColor="Red" ValidationGroup="error">Por favor rellenar el campo.</asp:RequiredFieldValidator>
                   </div>
                   ...
                   <div class="form-group col-md-4">
                        ...
                        Display="Dynamic" SetFocusOnError="True" ForeColor="Red" ValidationGroup="error">Escribir sitio web</asp:RequiredFieldValidator>
                   </div>
                   ...
                   <div class="form-group col-md-4">
                        ...
                        Display="Dynamic" SetFocusOnError="True" ForeColor="Red" ValidationGroup="error">Por favor rellenar el campo con un telefono.</asp:RequiredFieldValidator>
                   </div>
                       ...
                       <asp:View ID="View1Car" runat="server">
                               ...
                               <div class="form-row mt-2 2">
                                  <div class="form-group col-12" >
                                      ...
                                      Display="Dynamic" SetFocusOnError="True" ForeColor="Red" ValidationGroup="error" >Please enter a correct field.</asp:RequiredFieldValidator>
                                  </div>
                                </div>
                                  <div class="form-row">  
                                      <div class="form-group col-12">
